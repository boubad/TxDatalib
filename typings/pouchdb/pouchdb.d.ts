...
declare class PouchDB implements PouchApi {
    //constructor(name: string, opts: PouchOptions, callback: (err: PouchError, res: PouchDB) => void);
    constructor(name: string, callback: (err: PouchError, res: PouchDB) => void);
