...
declare module 'QUnit' {
    ...
    * @param message A short description of the assertion
    */
    export function deepEqual(actual: any, expected: any, message?: string): any;
    ...
    * @param message A short description of the assertion
    */
    export function notDeepEqual(actual: any, expected: any, message?: string): any;
    ...
    * @param message A short description of the assertion
    */
    export function notEqual(actual: any, expected: any, message?: string): any;
    ...
    * @param message A short description of the assertion
    */
    export function notStrictEqual(actual: any, expected: any, message?: string): any;
    ...
    * @param message A short description of the assertion
    */
    export function ok(state: any, message?: string): any;
    ...
    * @param message A short description of the assertion
    */
    export function strictEqual(actual: any, expected: any, message?: string): any;
    ...
    * @param message A short description of the assertion
    */
    export function throws(block: () => any, expected: any, message?: string): any;

    /**
    * @param block Function to execute
    * @param message A short description of the assertion
    */
    export function throws(block: () => any, message?: string): any;
    ...
    * @param decrement Optional argument to merge multiple start() calls into one. Use with multiple corrsponding stop() calls.
    */
    export function start(decrement?: number): any;
    ...
    * @param decrement Optional argument to merge multiple stop() calls into one. Use with multiple corrsponding start() calls.
    */
    export function stop(increment?: number): any;
    ...
    * @param callback Callback to execute
    */
    export function begin(callback: () => any): any;
    ...
    * @param callback Callback to execute.
    */
    export function done(callback: (details: DoneCallbackObject) => any): any;
    ...
    * @param callback Callback to execute.
    */
    export function log(callback: (details: LogCallbackObject) => any): any;
    ...
    * @param callback Callback to execute.
    */
    export function moduleDone(callback: (details: ModuleDoneCallbackObject) => any): any;
    ...
    * @param callback Callback to execute.
    */
    export function moduleStart(callback: (name: string) => any): any;
    ...
    * @param callback Callback to execute.
    */
    export function testDone(callback: (details: TestDoneCallbackObject) => any): any;
    ...
    * @param callback Callback to execute.
    */
    export function testStart(callback: (details: TestStartCallbackObject) => any): any;
    ...
    * @param test Function to close over assertions
    */
    export function asyncTest(name: string, expected?: any, test?: (assert: QUnitAssert) => any): any;
    ...
    * @param test Function to close over assertions
    */
    export function asyncTest(name: string, test: (assert: QUnitAssert) => any): any;
    ...
    * @depricated since version 1.16
    */
    export function expect(amount: number): any;

    // ** conflict with TypeScript module keyword. Must be used on QUnit namespace
    //export var module: (name: string, lifecycle?: LifecycleObject) => any;
    ...
    * @param test Function to close over assertions
    */
    export function test(title: string, expected: number, test: (assert?: QUnitAssert) => any): any;

    /**
    * @param title Title of unit being tested
    * @param test Function to close over assertions
    */
    export function test(title: string, test: (assert?: QUnitAssert) => any): any;

    export function notPropEqual(actual: any, expected: any, message?: string): any;

    export function propEqual(actual: any, expected: any, message?: string): any;

    // https://github.com/jquery/qunit/blob/master/qunit/qunit.js#L1568
    export function equiv(a: any, b: any): any;

    // https://github.com/jquery/qunit/blob/master/qunit/qunit.js#L661
    export var raises: any;

    /* QUNIT */
    export var QUnit: QUnitStatic;
}// module qunit
